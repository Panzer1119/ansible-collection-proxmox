panzer1119.proxmox pve_qdevice Role
========================
...
- name: Execute tasks on servers
  hosts: servers
  roles:
    - role: panzer1119.proxmox.pve_qdevice
```

Another way to consume this role would be:

```yaml
- name: Initialize the pve_qdevice role from panzer1119.proxmox
  hosts: all
  gather_facts: false
  tasks:
    - name: Trigger invocation of pve_qdevice role
      ansible.builtin.include_role:
        name: panzer1119.proxmox.pve_qdevice
```
